        ...
        <div class="col-md-6">
            ...
            <input type="hidden" name="id" value="<?php echo $_settings->userdata('id') ?>">
                <div class="form-group">
                    ...
                    <input type="text" name="firstname" class="form-control form" pattern="[A-Za-z].{2,30}" title = "Enter only alphabets  minimum 2 characters and maximum 30 characters" value="<?php echo $_settings->userdata('firstname') ?>" required>
                </div>
                <div class="form-group">
                    <label for="lastname" class="control-label">Lastname</label>
                    <input type="text" name="lastname" class="form-control form" pattern="[A-Za-z].{2,30}" title = "Enter only alphabets  minimum 2 characters and maximum 30 characters" value="<?php echo $_settings->userdata('lastname') ?>" required>
                </div>
                <div class="form-group">
                    <label for="username" class="control-label">Username</label>
                    <input type="text" name="username" class="form-control form" pattern="^(?!.\.\.)(?!.\.$)[^\W][\w.]{5,15}$" title = "Should be of size 5-15 char and can include . and _ " value="<?php echo $_settings->userdata('username') ?>" required>
                </div>
                <div class="form-group">
                    <label for="password" class="control-label">New Password</label>
                    <input type="password" name="password" class="form-control form" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,30}" title ="Must be 8 or more characters containing atleast 1 number,upper case an lower case" value="" placeholder="(Enter value to change password)">
                </div>
                <div class="form-group">
